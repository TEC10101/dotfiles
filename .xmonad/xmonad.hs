...
myWorkspaces = [" main ", " dev ", " www ", " www2 ", " torr ", " vid ", " etc ", " sys ", " sys2 "]
...
myManageHook = composeAll
     ...
     , className =? "qBitTorrent"     --> doShift ( myWorkspaces !! 9 )
...
myKeys =
    ...
    -- KB_GROUP Useful programs to have a keybinding for launch
        ...
        , ("M-b", spawn "librewolf")--(myBrowser))
        , ("M-M1-h", spawn (myTerminal ++ " -e htop"))

    -- KB_GROUP Kill windows
        --, ("M-S-c", kill1)     -- Kill the currently focused client
        , ("M1-'", kill1)     -- Kill the currently focused client
        , ("M1-<F4>", kill1)     -- Kill the currently focused client
        , ("M-S-a", killAll)   -- Kill all windows on current workspace

    -- KB_GROUP Workspaces
        --, ("M-.", nextScreen)  -- Switch focus to next monitor
        , ("C-M1-<Right>", moveTo Next nonNSP)  -- Switch view to next workspace
        --, ("M-,", prevScreen)  -- Switch focus to prev monitor
        , ("C-M1-<Left>", moveTo Prev nonNSP)  -- Switch view to prev workspace
        , ("M-<Right>", shiftTo Next nonNSP >> moveTo Next nonNSP)       -- Shifts focused window to next ws
        , ("M-<Left>", shiftTo Prev nonNSP >> moveTo Prev nonNSP)  -- Shifts focused window to prev ws

    -- KB_GROUP Floating windows
        --, ("M-f", sendMessage (T.Toggle "floats")) -- Toggles my 'floats' layout --I added M-f to be full screen
